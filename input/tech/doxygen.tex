...
\begin{figure}[H]
\centering \includegraphics[scale=.35]{images/doxy.png}
\caption{Doxygen documentation of WebOctave}
\end{figure}
\begin{figure}[H]
\centering \includegraphics[scale=.35]{images/doxclasses.png}
\caption{Documentation using Doxygen(list of Classes)}
\end{figure}
